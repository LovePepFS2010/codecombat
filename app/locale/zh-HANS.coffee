module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  home:
    ...
    try_it: "体验游戏" # Alternate wording for Play button
  ...
  login:
    ...
    finishing: "完成..."
    sign_in_with_facebook: "使用FaceBook登陆"
    sign_in_with_gplus: "使用G+登陆"
    signup_switch: "创建一个新账户？"
  ...
  play_level:
    ...
    tip_think_solution: "思考解决问题的方法, 而不是问题本身."
    ...
    tip_debugging_program: "如果说调试是清除Bug的过程，那么编程就是放置Bug的过程。- Edsger W. Dijkstra"
    tip_forums: "到论坛去告诉我们你的想法!"
    tip_baby_coders: "未来，就算小孩都能成为大法师."
    ...
    tip_extrapolation: "世上只有两种人: 一种是能从不完整的数据中推测信息的人..."
  ...
  choose_hero:
    ...
    backstab: "偷袭" # As in "this dagger does this much backstab damage"
    skills: "技能"
  ...
  contact:
    ...
    forum_page: "我们的论坛"
    forum_suffix: ""
    subscribe_prefix: "如果您愿意帮助我们的网站建设，请"
    subscribe: "捐赠成为CodeCombat的会员，"
    subscribe_suffix: "我们将很乐意为您提供编程帮助。"
    subscriber_support: "一旦您成为我们的捐赠者, 您的邮件会被我们优先处理."
    where_reply: "我们应该在哪回复呢？"
    send: "反馈意见"
